            ...
            */
            ...
            if (type === 'ethersale') {
                ...
                // geth
                    ...
                    if (process.platform === 'darwin') keystorePath += '/Library/Soil/keystore';

                    if (process.platform === 'freebsd' ||
                        process.platform === 'linux' ||
                        process.platform === 'sunos') keystorePath += '/.soil/keystore';

                    if (process.platform === 'win32') keystorePath = `${Settings.appDataPath}\\Soil\\keystore`;
                }
